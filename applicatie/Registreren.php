...
<body>
    ...
    <section>
        ...
        <form action="index.php" method="post">
            <label>Naam: *</label>
            <input type="text" name="Naam"  maxlength="20" required placeholder="Vul hier uw naam in">
            ...
            <input type="text" name="Wachtwoord"  required placeholder="Vul hier uw wachtwoord in">
            <label>Herhaal: *</label>
            <input type="text" name="Herhaal"  required placeholder="Herhaal wachtwoord">
